      ...
      <form className='form' onSubmit={handleSubmit}>
        <dl className='form__list'>
          <div className='form__field'>
            <dt className='form__label'><label for='name'>お名前</label></dt>
          ...
          <div className='form__field'>
            <dt className='form__label'><label for='email'>メールアドレス</label></dt>
          ...
          <div className='form__field'>
            <dt className='form__label'><label for='content'>本文</label></dt>
            <dd className='form__data'><textarea type='text' id ='content' name='content' className='form__input textarea' value={message} onChange={(e) => setMessage(e.target.value)} disabled={isSubmitting} required></textarea></dd>
          </div>
